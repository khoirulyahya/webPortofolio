...
@section('title')
<title>Minargmnt-Apps | Data Member</title>
@endsection
            ...
            <div class="modal-content">
                <form method="post" :action="actionUrl" autocomplete="off" @submit="submitForm($event, data.id)">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" v-if="editSelect">Create New Member</h4>
                        <h4 class="modal-title" v-if="editStatus">Update Data Member</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row form-group">
                            <div class="col-4">
                                <input hidden type="text" name="member_code" :value="data.member_code" class="form-control">
                            </div>
                        </div>
                    </div>
