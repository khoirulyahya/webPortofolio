...
@section('title')
<title>Minargmnt-Apps | Data Officer</title>
@endsection
...
@section('header')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active text-white">Officer</li>
        </ol>
    </div>
@endsection
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row justify-content-between">
                        <div class="col-md-3">
                            <a href="#" @click="addData()" class="btn btn-sm btn-primary pull-right">Create New Officer</a>
                        </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered w-auto">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center align-middle"><b>Officer ID</b></th>
            ...
            <div class="modal-content">
                <form method="post" :action="actionUrl" autocomplete="off" @submit="submitForm($event, data.id)">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" v-if="editSelect">Create New Officer</h4>
                        <h4 class="modal-title" v-if="editStatus">Update Data Officer</h4>
...
@section('js')
    ...
    <script type="text/JavaScript" >
        var actionUrl = '{{ url('officers') }}';
        var apiUrl = '{{ url('api/officers') }}';

        {{--  Menyimpan dan menata data dari api ke dalam variable column  --}}
        var columns = [
                        {data: 'DT_RowIndex', class: 'text-center', orderable: true},
                        {data: 'officer_code', orderable: true},
